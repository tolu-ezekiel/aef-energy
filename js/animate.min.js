...
Port = {
	initialize: function () {
		...
		//             $(".navbar-fixed-top").removeClass("transparent-navbar");
		//             $(".navbar-fixed-top").addClass("opaque-navbar");
		//             $(".navbar-nav").removeClass("transparent-link");
		//         } else {
		//            $(".navbar-fixed-top").addClass("transparent-navbar");
		//             $(".navbar-fixed-top").removeClass("opaque-navbar");
		//            $(".navbar-nav").addClass("transparent-link");
		//         }
		//     });
		// });
	},
